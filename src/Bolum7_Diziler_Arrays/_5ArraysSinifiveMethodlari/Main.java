...
public class Main {
    public static void main(String[] args) {
        ...
        helper.printArray(sList);

        //dizinin önce sıralanması lazım .sort ile
        //Arrays.binarySearch() methedu aradığım eleman indexi veriyor.
        System.out.println(Arrays.binarySearch(list,4));//3. indexteymiş.
        System.out.println(Arrays.toString(list));
        //fill() doldur methodu .
        //Bu işlemi manuelde yapabilirim
        helper.fill(list,1);
        Arrays.fill(list,0,2,10);
        System.out.println(Arrays.toString(list));

        System.out.println(Arrays.toString(list));

        //Array Sınıfı methodları to String ile yazdırabiliriyoruz.
        System.out.println(Arrays.toString(list));


        //Arrays. Sort() methodu Sıralamak için kullanıyoruz

        Arrays.sort(list);
        System.out.println(Arrays.toString(list));

        //Arrays.copyOf() ve Arrays.copyOfRange() methodları
        //birebir kopyalarım
        int[] copyList= Arrays.copyOf(list,list.length);
        //istediğim indexe kadar kopyalarım
        int[] copyList2= Arrays.copyOf(list,3);
        //aralık belirlemek istersem 2.indexten 5 e kadar mesela
        ...
        //Arrays.equals()methodu 2 diinin eşitliğini kontrol edebilirim
        System.out.println(Arrays.equals(list,copyList3));
        //doğruysa true yanlışsa false dönüyuor.
