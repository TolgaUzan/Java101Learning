package Bolum6_Siniflar_Classes._6Odev_MaasHesaplayıcı;
...
public class Main {
    public static void main(String[] args) {
        ...
        Employee calisan= new Employee("Tolga",1000,45,1992);
        calisan.toString();
        ...
        çalışanların maaşlarını hesaplayan bir sınıf yazmalısınız. Bu sınıf 4 nitelik ve 5 metoda sahip olacaktır.
