package Bolum10__ObjectOrientedProgramingNYP._4SinifDiagramOrnekleri;
...
Hesap (Account) sınıfına ait iki tane alt sınıf vardır, Ana Hesap
(Main Account) ve Birikim Hesabı (Saving Account).
